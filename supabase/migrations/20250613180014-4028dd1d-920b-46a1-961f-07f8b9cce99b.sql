-- Remove foreign key constraint on related_proposal_id to allow storing conversation IDs
ALTER TABLE public.notifications DROP CONSTRAINT IF EXISTS notifications_related_proposal_id_fkey;

-- Update the message notification function to store conversation_id properly  
...
BEGIN
  ...
  -- Create notification for the recipient with conversation_id stored in related_proposal_id
